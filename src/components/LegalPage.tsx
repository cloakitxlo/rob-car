...
export const LegalPage: React.FC<LegalPageProps> = ({
  ...
  return (
    <div className="landing-root min-h-screen">
      <header className="sticky top-0 z-40 bg-[#110e08]/95 backdrop-blur-xl border-b border-white/[0.08]">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="landing-display text-white text-sm sm:text-base">Robin Card</span>
          </div>
          <button
            type="button"
      ...
      <main className="max-w-3xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#ccff00] mb-3">Legal</p>
        <h1 className="landing-display text-3xl sm:text-4xl text-white mb-2">
          {title}
        </h1>
        <p className="text-sm text-[#6a6760] mb-10">Last updated: {UPDATED}</p>

        <article className="legal-prose space-y-8 text-sm sm:text-[15px] text-[#e8e5dc] leading-relaxed">
          {doc === 'privacy' ? <PrivacyBody /> : <TermsBody />}
        </article>

        <div className="mt-12 pt-8 border-t border-white/[0.08] flex flex-wrap gap-4 text-sm">
          <button type="button" onClick={onOpenPrivacy} className="font-semibold text-[#ccff00] hover:text-[#dbff40]">
            Privacy Policy
          </button>
          <button type="button" onClick={onOpenTerms} className="font-semibold text-[#ccff00] hover:text-[#dbff40]">
            Terms &amp; Conditions
          </button>
      ...
      <footer className="border-t border-white/[0.08] py-6 text-center text-xs text-[#6a6760]">
        © {new Date().getFullYear()} Robin Card. All rights reserved.
      </footer>
    </div>
  );
};
  ...
  return (
    <>
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">1. Who we are</h2>
        <p>
          This Privacy Policy explains how Robin Card (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) collects, uses, shares, and protects information when you visit our website, create an account, or use our crypto card and wallet portal (the &quot;Services&quot;).
        </p>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">2. Information we collect</h2>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">3. Cookies, pixels &amp; analytics</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">4. How we use information</h2>
        <ul className="list-disc pl-5 space-y-2">
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">5. Legal bases (where applicable)</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">6. Sharing of information</h2>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">7. Data retention</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">8. Security</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">9. Your rights &amp; choices</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">10. Children</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">11. International transfers</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">12. Third-party links &amp; platforms</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">13. Changes to this policy</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">14. Contact</h2>
        <p>
          Questions about privacy: use Support inside your Robin Card account, or contact the site operator using the official channels listed on the website.
        </p>
      </section>
    </>
  );
...
function TermsBody() {
  return (
    <>
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">1. Agreement to terms</h2>
        <p>
          By accessing or using Robin Card websites, applications, and related services (the &quot;Services&quot;), you agree to these Terms &amp; Conditions (&quot;Terms&quot;). If you do not agree, do not use the Services.
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">2. Eligibility</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">3. The Services</h2>
        <p>
          Robin Card provides a portal to manage a crypto-linked card experience, including account access, vault balances, card controls, activity history, and support. Features may change, be limited by region, or require additional verification depending on risk, compliance, or operational needs.
        </p>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">4. Accounts &amp; security</h2>
        <ul className="list-disc pl-5 space-y-2">
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">5. Crypto deposits, balances &amp; card use</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">6. Acceptable use</h2>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">7. Fees</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">8. Intellectual property</h2>
        <p>
          The Services, branding, UI, and content are owned by Robin Card or its licensors. You receive a limited, non-exclusive, non-transferable license to use the Services for personal or internal lawful purposes in accordance with these Terms.
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">9. Third-party services &amp; advertising compliance</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">10. Disclaimers</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">11. Limitation of liability</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">12. Indemnity</h2>
        <p>
          You agree to indemnify and hold harmless Robin Card and its operators from claims, damages, losses, and expenses (including reasonable legal fees) arising from your use of the Services, your deposits/transfers, or your violation of these Terms or applicable law.
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">13. Suspension &amp; termination</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">14. Changes to the Terms</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">15. Governing law</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="landing-display text-lg text-white">16. Contact</h2>
        <p>
          For questions about these Terms, use the Support Center after signing in, or contact us through official channels published on the Robin Card website.
        </p>
      </section>
    </>
  );
