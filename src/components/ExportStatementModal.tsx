...
export const ExportStatementModal: React.FC<ExportStatementModalProps> = ({
  ...
  onClose,
  transactions,
  cardHolderName = 'ROBIN CARD MEMBER',
  cardLastFour = '4532',
  cardTier = 'BLACK TIER',
}) => {
  ...
  const handleGeneratePDF = () => {
    ...
    setTimeout(() => {
      try {
        ...
        doc.setFontSize(18);
        doc.text('ROBIN CARD FINANCIAL STATEMENT', 14, 20);
        ...
        doc.text('Robin Card Financial Statement • End-to-End Encrypted • Official Record', 14, 285);
